<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
	pageEncoding="utf-8"
	import="javax.persistence.*,java.util.*,com.eni.dvtejb.web.*"%>
...
<body>
	<center>
		...
		<form action="requeteur.jsp" method="post">
			...
			<textarea name="requete" rows="10" cols="70">${param.requete}</textarea>
			<br /> <input type="submit" value="Lancer la requête JPQL" />
		</form>
		<p />
		<%
